...
try:
    client.collections["Jesuiten Littera annuae"].delete()
except ObjectNotFound:
    pass

current_schema = {
    "name": "Jesuiten Littera annuae",
    "fields": [
        {"name": "id", "type": "string"},
...
for x in tqdm(files, total=len(files)):
    ...
    for v in facs:
        ...
        pages += 1
        cfts_record = {
            "project": "Jesuiten Littera annuae",
        }
        record = {}
...
print(make_index)
print("done with indexing Jesuiten Littera annuae")

make_index = CFTS_COLLECTION.documents.import_(cfts_records, {"action": "upsert"})
print(make_index)
print("done with cfts-index Jesuiten Littera annuae")
